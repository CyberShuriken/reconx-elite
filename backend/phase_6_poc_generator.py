...
class POCGenerator:
    ...
    def _generate_idor_poc(self, endpoint: str, payload: dict[str, Any], session_token: str, base_url: str) -> dict[str, Any]:
...
"""
    ...
    def _generate_ssrf_poc(self, endpoint: str, payload: dict[str, Any], session_token: str, base_url: str) -> dict[str, Any]:
...
"""
    ...
    def _generate_injection_poc(self, endpoint: str, payload: dict[str, Any], session_token: str, base_url: str) -> dict[str, Any]:
...
"""
    ...
    def _generate_business_logic_poc(self, endpoint: str, payload: dict[str, Any], session_token: str, base_url: str) -> dict[str, Any]:
...
"""
    ...
    def _generate_generic_poc(self, endpoint: str, payload: dict[str, Any] | str, session_token: str, base_url: str) -> dict[str, Any]:
