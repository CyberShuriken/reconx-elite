...
class ContextTree:
    ...
    async def _analyze_host_technology(self, host: str) -> None:
        ...
        try:
            ...
            for indicator in all_indicators:
                ...
                # Avoid duplicates
                if not any(t.name == tech_component.name and t.category == tech_component.category 
    ...
    def _identify_priority_targets(self) -> List[str]:
        ...
        high_risk_endpoints = [
            e.url for e in self.interesting_endpoints 
        ...
        auth_apis = [
            e.url for e in self.api_endpoints 
            if e.auth_required
        ]
