...
class IntelligenceTests(unittest.TestCase):
    def test_normalize_and_score_endpoint_shape(self):
        ...
        self.assertEqual(rows[0]["normalized_url"], "https://app.example.com/admin/users?id&user")
    ...
    def test_extracts_only_in_scope_js_endpoints(self):
        ...
        extracted = extract_endpoints_from_javascript(js, "https://app.example.com/static/app.js", {"app.example.com"})
    ...
    def test_extract_secret_like_strings_returns_snippets(self):
        secrets = extract_secret_like_strings('const api_key = "ABCDEFGHIJKLMNOP123456";')
    ...
    def test_build_subdomain_record_marks_takeover_candidates(self):
        record = build_subdomain_record(
            "staging.example.com",
            {"staging.example.com": {"cname": "dangling.azurewebsites.net", "ip": "1.2.3.4", "tech_stack": []}},
            set(),
        )
